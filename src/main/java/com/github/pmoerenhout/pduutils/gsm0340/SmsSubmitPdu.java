...
public class SmsSubmitPdu extends Pdu {
  ...
  private ZonedDateTime validityPeriodTimeStamp;
  ...
  public void setValidityTimestamp(ZonedDateTime date) {
  ...
  public Calendar getValidityDateAsCalendar() {
    return GregorianCalendar.from(this.validityPeriodTimeStamp);
  }
